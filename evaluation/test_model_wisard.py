...
=============================================================================
  ...
  Dataset  : wisard_ir Dataset
  Model    : best.pt (yolov8n_optimized)
  Output   : D:/RISET/drone-wisard/test_performa/wisard_ir/
=============================================================================
"""
...
DATA_YAML    = r"D:\RISET\drone-wisard\datasets\wisard_ir\data.yaml"
TEST_IMG_DIR = r"D:\RISET\drone-wisard\datasets\wisard_ir\images\test"
TEST_LBL_DIR = r"D:\RISET\drone-wisard\datasets\wisard_ir\labels\test"
OUTPUT_DIR   = r"D:\RISET\drone-wisard\test_performa\wisard_ir\wisard_ir_Output"
...
def main():
    ...
    print("=" * 70)
    print("  YOLOv8n Model Evaluation — wisard_ir Dataset")
    print("=" * 70)
    ...
    fig.suptitle('YOLOv8n Model Evaluation — wisard_ir Dataset',
    ...
    # Title
    ax.text(0.5, 0.95, 'YOLOv8n — wisard_ir Test Evaluation Report',
